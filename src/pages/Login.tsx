      ...
      <div className="relative z-10 w-full max-w-md mx-auto px-6">
        ...
        <LuxuryCard variant="glass" className="animate-scale-in">
          <LuxuryCardHeader className="text-center">
            ...
            <LuxuryCardTitle className="text-2xl mb-2">Welcome Back</LuxuryCardTitle>
            <p className="text-muted-foreground">
              Sign in to access your premium AI platform
            </p>
          </LuxuryCardHeader>
          ...
          <LuxuryCardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="h-12 rounded-xl border-border/50 focus:ring-gold"
                  required
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <Input
                    ...
                    className="h-12 rounded-xl border-border/50 focus:ring-gold pr-10"
                    required
                  />
                  <button
                    type="button"
              ...
              <LuxuryButton type="submit" variant="hero" className="w-full h-12">
                Sign In
              </LuxuryButton>
            </form>
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <LuxuryButton variant="outline" className="h-12">
